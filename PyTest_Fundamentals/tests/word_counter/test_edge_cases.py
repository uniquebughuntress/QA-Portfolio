...
"""
Tests für Randfälle der Funktion ``count_word_matches``.

Die Tests verwenden ein Fixture mit typischen Randfall-Eingaben und
überprüfen das Verhalten bei leeren Eingaben, zusätzlichen Leerzeichen
und Interpunktion.
"""
